...
CREATE TABLE products (
	id SERIAL PRIMARY KEY,
	catalog_id INT UNSIGNED NOT NULL,     -- раздел, к которому относится конкретный товар
	name VARCHAR(255) NOT NULL COMMENT 'Название',
	description VARCHAR(10000) COMMENT 'Описание',
	price DECIMAL (11,2) COMMENT 'Цена',
	attributes JSON NOT NULL COMMENT 'Характеристики', -- атрибуты товара в виде "аттрибут : значение"
	picture_id INT UNSIGNED,     -- основная картинка товара
	created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
	updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	KEY products_picture_id_fk (picture_id),
...
CREATE TABLE pictures(
	id SERIAL PRIMARY KEY,
	product_id INT UNSIGNED NOT NULL, -- к какому товару эта картинка относится
	filename VARCHAR(255) NOT NULL,
	created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
	updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	KEY pictures_product_id_fk (product_id)
...
CREATE TABLE shops_products(
	...
	created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
	updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	KEY shops_products_shop_id_fk (shop_id),
...
CREATE TABLE orders (
	id SERIAL PRIMARY KEY,
	user_id INT UNSIGNED NOT NULL,  -- чей заказ
	created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
	updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- а вот состав заказов решил попробовать реализовать отдельной таблицей
DROP TABLE IF EXISTS orders_products;
CREATE TABLE orders_products (
	id SERIAL PRIMARY KEY,
	order_id INT UNSIGNED NOT NULL, -- номер заказа
	product_id INT UNSIGNED NOT NULL, -- номер товарной позиции
...
CREATE TABLE markdowns(
	...
	shop_id INT UNSIGNED NOT NULL COMMENT 'Магазин',
	KEY markdowns_product_id_fk (product_id)
...
CREATE TABLE opinions(
	...
	KEY opinions_product_id_fk (product_id)
) COMMENT 'Отзывы';
